...
export default function AboutMe() {
    return (
        <section className="flex items-center justify-center">
            <div className="flex flex-col lg:flex-row items-center w-full max-[500px]:max-w-[95%] max-w-[65%] lg:max-w-[88%] xl:max-w-[70%] 2xl:max-w-[60%] rounded-xl bg-black/30 shadow-2xl p-4 sm:p-8 lg:p-10 xl:p-12 transition-all duration-300">
